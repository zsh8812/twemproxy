...
struct msglist {
    uint64_t msg_id;          /* message id counter */
    uint64_t frag_id;         /* fragment id counter */
    uint32_t nfree_msgq;      /* # free msg q */
    struct msg_tqh free_msgq; /* free msg q */
...
uint64_t msg_gen_frag_id(struct msglist* msg_list);
